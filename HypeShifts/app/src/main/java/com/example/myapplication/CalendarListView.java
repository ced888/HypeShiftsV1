...
/**
 * CalendarListView is a fragment that displays a calendar with the ability to
 * navigate between weeks and switch to a month view representation.
 *
 * @author Cedric De Leon, Nicholas Westly, Sergei Borja
 * @since 2023.10.15
 */
public class CalendarListView extends Fragment implements CalendarAdapter.OnItemListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_calendar_list_view, container, false);
    }
    ...
    private void initializeUI(View view) {
        // Set up Buttons
        ImageView previousButton = view.findViewById(R.id.btnPreviousWeek);
        ImageView nextButton = view.findViewById(R.id.btnNextWeek);
        LinearLayout listViewButton = view.findViewById(R.id.btnView);
        ...
        listViewButton.setOnClickListener(this::switchToMonthViewFragment);
        createShiftButton.setOnClickListener(this::onAddShiftsClick);
    }

    /**
     * Sets up the week view in the calendar. This involves displaying the days of the week and any assigned shifts.
     */
    private void setWeekView() {
        ...
        // Set the assigned employees for the selected date
        if (!db.employeeDao().getAll().isEmpty())
            setAssignedEmployees(selectedDate);
    }

    /**
     * Handles the action to navigate to the previous week in the calendar.
     *
    ...
    /**
     * Handles the action to navigate to the next week in the calendar.
     *
     * @param view The view that triggered this action.
     */
    ...
    /**
     * Switch to the month view of the calendar.
     *
     * @param view The view (button) that triggers this action.
     */
    public void switchToMonthViewFragment(View view) {
    ...
    private void setAssignedEmployees(LocalDate date) {
        ...
        // Assigns employees to the different employee list to determine if they are working or not and which shift type
